...
parser.add_argument('--lr', type=float, default=0.05, help='Learning rate of the model, default: 0.001')
...
def main():
    ...
    # dataset_val_clean, dataset_val_poisoned = build_testset(is_train=False, args=args, transform_train=transform_train,
